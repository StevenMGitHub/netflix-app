...
const ReactPlayer = dynamic(() => import("react-player/lazy"), { ssr: false }); /* importamos 'react-player-lazy' para evitar error de hidratacion */
      ...
      <div className="container">
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 h-[100vh] justify-center lg:pb-12">
          <div className="absolute top-0 left-0 -z-10 h-screen w-screen">
            <Image
              fill
              src={`${baseUrl}${movie?.backdrop_path || movie?.poster_path}`} /* aveces tenemos una ruta de fondo o ruta de poster */
          ...
          <div className="flex space-x-3"> {/* mostrar al usuario opciones de reproducir o informacion */}
            <button
